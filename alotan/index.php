      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 pr-5">
            ...
            <h2 class="mb-3">Pelayanan Pelanggan</h2>
            <p class="mb-5">Dilakukan oleh tenaga ahli, profesonal, dan hasil yang berkualitas</p>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h2>Layanan Jenderal Barbershop</h2>
            <p>Nikmati Layanan Terbaik Di Tempat Kami</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="media d-block media-feature text-center">
              ...
              <div class="media-body">
                ...
                <p>Rambut yang rapi tentunya memberi poin tambahan untuk penampilan</p>
              </div>
            </div>
          ...
          <div class="col-md-4">
            <div class="media d-block media-feature text-center">
              ...
              <div class="media-body">
                <h3>Krim & Shampo</h3>
                <p>Rambut adalah mahkota bagi setiap orang, bukan hanya perempuan, tapi untuk pria juga</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="media d-block media-feature text-center">
              ...
              <div class="media-body">
                <h3>Perawatan Kumis</h3>
                <p>Bagi kaum Adam, kumis bisa jadi merupakan sesuatu yang sangat diinginkan untuk terlihat laki</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="media d-block media-feature text-center">
              ...
              <div class="media-body">
                <h3>Creambath</h3>
                <p>perawatan rambut menggunakan krim mengandung nutrisi penting untuk rambut dan kesehatan kulit kepala</p>
              </div>
            </div>
          ...
          <div class="col-md-4">
            <div class="media d-block media-feature text-center">
              <div class="mr-3 icon-wrap"><span class="custom-icon flaticon-cream"></span></div>
              <div class="media-body">
                <h3>Highlights & Lowlights (Mewarnai Rambut)</h3>
                <p>Mewarnai rambut dengan warna yang lebih terang dari warna asli rambut dan lebih gelap dari rambut</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="media d-block media-feature text-center">
              <div class="mr-3 icon-wrap"><span class="custom-icon flaticon-cream"></span></div>
              <div class="media-body">
                <h3>Smoothing & Rebonding</h3>
                <p>merujuk pada proses pelurusan rambut dengan lurus patah, sedangkan smoothing merujuk pada pelurusan rambut dengan hasil yang lebih natural</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center intro">
          <div class="col-md-8 text-center element-animate">
            <h2 class="mb-4"><span>Potong rambut</span> Dapatkan diskon 10%</h2>
            <p><a href="#" class="btn btn-black">Hanya dengan menggunakan kartu debit</a></p>
          </div>
        </div>
      </div>
    </section>
